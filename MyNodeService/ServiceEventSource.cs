...
{
    [EventSource(Name = "MyCompany-my_akka_cluster_service_fabric-MyNodeService")]
    internal sealed class ServiceEventSource : EventSource, Shared.IServiceEventSource
    {
